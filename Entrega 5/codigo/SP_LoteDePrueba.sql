...
BEGIN
    ...
    BEGIN TRY
        ...
        INSERT INTO dbo.Persona (id, dni, nombre, apellido, email, telefono, cvu_cbu) VALUES
        -- Consorcio 1
        (1, 20345678, 'Juan', 'Pérez', 'jperez@email.com', '01145678901', '0000003100012345678901'),
        (2, 30456789, 'María', 'González', 'mgonzalez@email.com', '01145678902', '0000003100012345678902'),
        (3, 25567890, 'Carlos', 'Rodríguez', 'crodriguez@email.com', '01145678903', '0000003100012345678903'),
        (4, 28678901, 'Ana', 'Martínez', 'amartinez@email.com', '01145678904', '0000003100012345678904'),
        (5, 32789012, 'Luis', 'López', 'llopez@email.com', '01145678905', '0000003100012345678905'),
        (6, 27890123, 'Laura', 'Fernández', 'lfernandez@email.com', '01145678906', '0000003100012345678906'),
        (7, 31901234, 'Diego', 'Sánchez', 'dsanchez@email.com', '01145678907', '0000003100012345678907'),
        (8, 29012345, 'Sofía', 'Romero', 'sromero@email.com', '01145678908', '0000003100012345678908'),
        (9, 33123456, 'Pablo', 'Torres', 'ptorres@email.com', '01145678909', '0000003100012345678909'),
        (10, 26234567, 'Claudia', 'Benítez', 'cbenitez@email.com', '01145678910', '0000003100012345678910'),
        (11, 34345678, 'Martín', 'Castro', 'mcastro@email.com', '01145678911', '0000003100012345678911'),
        (12, 28456789, 'Valeria', 'Ruiz', 'vruiz@email.com', '01145678912', '0000003100012345678912'),
        -- Consorcio 2
        (13, 22567890, 'Roberto', 'Silva', 'rsilva@email.com', '01145678913', '0000003100012345678913'),
        (14, 35678901, 'Gabriela', 'Moreno', 'gmoreno@email.com', '01145678914', '0000003100012345678914'),
        (15, 29789112, 'Fernando', 'Ramos', 'framos@email.com', '01145678915', '0000003100012345678915'),
        (16, 71890123, 'Patricia', 'Álvarez', 'palvarez@email.com', '01145678916', '0000003100012345678916'),
        (17, 27901234, 'Gustavo', 'Méndez', 'gmendez@email.com', '01145678917', '0000003100012345678917'),
        (18, 33012345, 'Mónica', 'Ríos', 'mrios@email.com', '01145678918', '0000003100012345678918'),
        (19, 26123456, 'Alejandro', 'Ortiz', 'aortiz@email.com', '01145678919', '0000003100012345678919'),
        (20, 34234567, 'Cecilia', 'Navarro', 'cnavarro@email.com', '01145678920', '0000003100012345678920'),
        (21, 28345678, 'Ricardo', 'Paz', 'rpaz@email.com', '01145678921', '0000003100012345678921'),
        (22, 32456789, 'Silvia', 'Vega', 'svega@email.com', '01145678922', '0000003100012345678922'),
        (23, 27567890, 'Marcelo', 'Luna', 'mluna@email.com', '01145678923', '0000003100012345678923'),
        (24, 30678901, 'Andrea', 'Cruz', 'acruz@email.com', '01145678924', '0000003100012345678924'),
        -- Consorcio 3
        (25, 29789012, 'Jorge', 'Herrera', 'jherrera@email.com', '01145678925', '0000003100012345678925'),
        (26, 31897123, 'Liliana', 'Campos', 'lcampos@email.com', '01145678926', '0000003100012345678926'),
        (27, 27901214, 'Sergio', 'Rojas', 'srojas@email.com', '01145678927', '0000003100012345678927'),
        (28, 33012245, 'Beatriz', 'Molina', 'bmolina@email.com', '01145678928', '0000003100012345678928'),
        (29, 26023456, 'Raúl', 'Peralta', 'rperalta@email.com', '01145678929', '0000003100012345678929'),
        (30, 34234561, 'Marina', 'Cabrera', 'mcabrera@email.com', '01145678930', '0000003100012345678930'),
        (31, 28945678, 'Eduardo', 'Suárez', 'esuarez@email.com', '01145678931', '0000003100012345678931'),
        (32, 32056789, 'Daniela', 'Medina', 'dmedina@email.com', '01145678932', '0000003100012345678932'),
        (33, 25568890, 'Héctor', 'Guzmán', 'hguzman@email.com', '01145678933', '0000003100012345678933'),
        (34, 30678001, 'Isabel', 'Acosta', 'iacosta@email.com', '01145678934', '0000003100012345678934'),
        (35, 29789011, 'Nicolás', 'Sosa', 'nsosa@email.com', '01145678935', '0000003100012345678935'),
        (36, 31790123, 'Verónica', 'Palacios', 'vpalacios@email.com', '01145678936', '0000003100012345678936'),
        -- Consorcio 4
        (37, 27901232, 'Adrián', 'Arias', 'aarias@email.com', '01145678937', '0000003100012345678937'),
        (38, 33012945, 'Natalia', 'Miranda', 'nmiranda@email.com', '01145678938', '0000003100012345678938'),
        (39, 29123456, 'Oscar', 'Vargas', 'ovargas@email.com', '01145678939', '0000003100012345678939'),
        (40, 34234562, 'Carolina', 'Sandoval', 'csandoval@email.com', '01145678940', '0000003100012345678940'),
        (41, 28045678, 'Federico', 'Espinoza', 'fespinoza@email.com', '01145678941', '0000003100012345678941'),
        (42, 32256789, 'Paola', 'Cortés', 'pcortes@email.com', '01145678942', '0000003100012345678942'),
        (43, 25567891, 'Javier', 'Ibáñez', 'jibanez@email.com', '01145678943', '0000003100012345678943'),
        (44, 30678801, 'Florencia', 'Paredes', 'fparedes@email.com', '01145678944', '0000003100012345678944'),
        (45, 29781012, 'Damián', 'Aguilar', 'daguilar@email.com', '01145678945', '0000003100012345678945'),
        (46, 31890123, 'Lucía', 'Mendoza', 'lmendoza@email.com', '01145678946', '0000003100012345678946'),
        (47, 27903234, 'Emilio', 'Bravo', 'ebravo@email.com', '01145678947', '0000003100012345678947'),
        (48, 33012845, 'Romina', 'Duarte', 'rduarte@email.com', '01145678948', '0000003100012345678948');
        ...
        INSERT INTO dbo.Persona_UF (id_consorcio, id_uf, cvu_cbu, id_tipo_relacion, fecha) VALUES
