...
BEGIN
    ...
    BEGIN TRY
        ...
        DELETE FROM dbo.Gasto_Extraordinario;
        DELETE FROM dbo.Gasto_Ordinario;
        DELETE FROM dbo.Detalle_Expensa;
        DELETE FROM dbo.Expensa;
        DELETE FROM dbo.Persona_UF;
        DELETE FROM dbo.Adicionales;
        DELETE FROM dbo.UF;
        DELETE FROM dbo.Proveedor_Consorcio;
        DELETE FROM dbo.Consorcio;
        DELETE FROM dbo.Persona;
        DELETE FROM dbo.Proveedor;
        DELETE FROM dbo.Tipo_Servicio;
        DELETE FROM dbo.Tipo_Gasto;
        DELETE FROM dbo.Tipo_adicional;
        DELETE FROM dbo.Tipo_relacion;
        ...
        INSERT INTO dbo.Proveedor (id, razon_social) VALUES
        ...
        INSERT INTO dbo.Persona (id, dni, nombre, apellido, email, telefono, cvu_cbu, id_tipo_relacion) VALUES
-- Consorcio 1
(1, 20345678, 'Juan', 'Pérez', 'jperez@email.com', '01145678901', '0000003100012345678901', 1),
(2, 30456789, 'María', 'González', 'mgonzalez@email.com', '01145678902', '0000003100012345678902', 1),
(3, 25567890, 'Carlos', 'Rodríguez', 'crodriguez@email.com', '01145678903', '0000003100012345678903', 1),
(4, 28678901, 'Ana', 'Martínez', 'amartinez@email.com', '01145678904', '0000003100012345678904', 1),
(5, 32789012, 'Luis', 'López', 'llopez@email.com', '01145678905', '0000003100012345678905', 0),
(6, 27890123, 'Laura', 'Fernández', 'lfernandez@email.com', '01145678906', '0000003100012345678906', 0),
(7, 31901234, 'Diego', 'Sánchez', 'dsanchez@email.com', '01145678907', '0000003100012345678907', 0),
(8, 29012345, 'Sofía', 'Romero', 'sromero@email.com', '01145678908', '0000003100012345678908', 0),
(9, 33123456, 'Pablo', 'Torres', 'ptorres@email.com', '01145678909', '0000003100012345678909', 1),
(10, 26234567, 'Claudia', 'Benítez', 'cbenitez@email.com', '01145678910', '0000003100012345678910', 1),
(11, 34345678, 'Martín', 'Castro', 'mcastro@email.com', '01145678911', '0000003100012345678911', 1),
(12, 28456789, 'Valeria', 'Ruiz', 'vruiz@email.com', '01145678912', '0000003100012345678912', 1),
-- Consorcio 2
(13, 22567890, 'Roberto', 'Silva', 'rsilva@email.com', '01145678913', '0000003100012345678913', 0),
(14, 35678901, 'Gabriela', 'Moreno', 'gmoreno@email.com', '01145678914', '0000003100012345678914', 0),
(15, 29789112, 'Fernando', 'Ramos', 'framos@email.com', '01145678915', '0000003100012345678915', 0),
(16, 71890123, 'Patricia', 'Álvarez', 'palvarez@email.com', '01145678916', '0000003100012345678916', 0),
(17, 27901234, 'Gustavo', 'Méndez', 'gmendez@email.com', '01145678917', '0000003100012345678917', 1),
(18, 33012345, 'Mónica', 'Ríos', 'mrios@email.com', '01145678918', '0000003100012345678918', 1),
(19, 26123456, 'Alejandro', 'Ortiz', 'aortiz@email.com', '01145678919', '0000003100012345678919', 1),
(20, 34234567, 'Cecilia', 'Navarro', 'cnavarro@email.com', '01145678920', '0000003100012345678920', 1),
(21, 28345678, 'Ricardo', 'Paz', 'rpaz@email.com', '01145678921', '0000003100012345678921', 0),
(22, 32456789, 'Silvia', 'Vega', 'svega@email.com', '01145678922', '0000003100012345678922', 0),
(23, 27567890, 'Marcelo', 'Luna', 'mluna@email.com', '01145678923', '0000003100012345678923', 0),
(24, 30678901, 'Andrea', 'Cruz', 'acruz@email.com', '01145678924', '0000003100012345678924', 0),
-- Consorcio 3
(25, 29789012, 'Jorge', 'Herrera', 'jherrera@email.com', '01145678925', '0000003100012345678925', 1),
(26, 31897123, 'Liliana', 'Campos', 'lcampos@email.com', '01145678926', '0000003100012345678926', 1),
(27, 27901214, 'Sergio', 'Rojas', 'srojas@email.com', '01145678927', '0000003100012345678927', 1),
(28, 33012245, 'Beatriz', 'Molina', 'bmolina@email.com', '01145678928', '0000003100012345678928', 1),
(29, 26023456, 'Raúl', 'Peralta', 'rperalta@email.com', '01145678929', '0000003100012345678929', 0),
(30, 34234561, 'Marina', 'Cabrera', 'mcabrera@email.com', '01145678930', '0000003100012345678930', 0),
(31, 28945678, 'Eduardo', 'Suárez', 'esuarez@email.com', '01145678931', '0000003100012345678931', 0),
(32, 32056789, 'Daniela', 'Medina', 'dmedina@email.com', '01145678932', '0000003100012345678932', 0),
(33, 25568890, 'Héctor', 'Guzmán', 'hguzman@email.com', '01145678933', '0000003100012345678933', 1),
(34, 30678001, 'Isabel', 'Acosta', 'iacosta@email.com', '01145678934', '0000003100012345678934', 1),
(35, 29789011, 'Nicolás', 'Sosa', 'nsosa@email.com', '01145678935', '0000003100012345678935', 1),
(36, 31790123, 'Verónica', 'Palacios', 'vpalacios@email.com', '01145678936', '0000003100012345678936', 1),
-- Consorcio 4
(37, 27901232, 'Adrián', 'Arias', 'aarias@email.com', '01145678937', '0000003100012345678937', 0),
(38, 33012945, 'Natalia', 'Miranda', 'nmiranda@email.com', '01145678938', '0000003100012345678938', 0),
(39, 29123456, 'Oscar', 'Vargas', 'ovargas@email.com', '01145678939', '0000003100012345678939', 0),
(40, 34234562, 'Carolina', 'Sandoval', 'csandoval@email.com', '01145678940', '0000003100012345678940', 0),
(41, 28045678, 'Federico', 'Espinoza', 'fespinoza@email.com', '01145678941', '0000003100012345678941', 1),
(42, 32256789, 'Paola', 'Cortés', 'pcortes@email.com', '01145678942', '0000003100012345678942', 1),
(43, 25567891, 'Javier', 'Ibáñez', 'jibanez@email.com', '01145678943', '0000003100012345678943', 1),
(44, 30678801, 'Florencia', 'Paredes', 'fparedes@email.com', '01145678944', '0000003100012345678944', 1),
(45, 29781012, 'Damián', 'Aguilar', 'daguilar@email.com', '01145678945', '0000003100012345678945', 0),
(46, 31890123, 'Lucía', 'Mendoza', 'lmendoza@email.com', '01145678946', '0000003100012345678946', 0),
(47, 27903234, 'Emilio', 'Bravo', 'ebravo@email.com', '01145678947', '0000003100012345678947', 0),
(48, 33012845, 'Romina', 'Duarte', 'rduarte@email.com', '01145678948', '0000003100012345678948', 0);
        SET IDENTITY_INSERT dbo.Persona OFF;
        
        SET IDENTITY_INSERT dbo.Consorcio ON;
        INSERT INTO dbo.Consorcio (id, razon_social, domicilio, m2) VALUES
        (1, 'Consorcio Edificio Las Rosas', 'Av. Rivadavia 1234, San Justo, Buenos Aires', 1200.00),
        (2, 'Consorcio Torres del Sur', 'Calle Italia 5678, San Justo, Buenos Aires', 980.50),
        (3, 'Consorcio Jardines de Abril', 'Av. San Martín 9012, San Justo, Buenos Aires', 1500.75),
        (4, 'Consorcio Plaza Mayor', 'Calle España 3456, San Justo, Buenos Aires', 1100.00);
        SET IDENTITY_INSERT dbo.Consorcio OFF;
        
        INSERT INTO dbo.UF (id_consorcio, id, m2, porcentaje, depto, piso) VALUES
        (1, 1, 85.50, 7.13, 'A', 0), (1, 2, 92.00, 7.67, 'B', 0), (1, 3, 78.25, 6.52, 'C', 0),
        (1, 4, 88.00, 7.33, 'A', 1), (1, 5, 88.00, 7.33, 'B', 1), (1, 6, 95.50, 7.96, 'C', 1),
        (1, 7, 105.00, 8.75, 'A', 2), (1, 8, 98.75, 8.23, 'B', 2), (1, 9, 110.00, 9.17, 'C', 2),
        (1, 10, 125.50, 10.46, 'A', 3), (1, 11, 118.00, 9.83, 'B', 3), (1, 12, 115.50, 9.63, 'C', 3);

        INSERT INTO dbo.UF (id_consorcio, id, m2, porcentaje, depto, piso) VALUES
        (2, 1, 65.00, 6.63, 'B', 0), (2, 2, 68.50, 6.98, 'A', 0), (2, 3, 72.00, 7.34, 'A', 1),
        (2, 4, 70.25, 7.16, 'C', 1), (2, 5, 75.00, 7.65, 'C', 1), (2, 6, 82.50, 8.41, 'D', 2),
        (2, 7, 85.00, 8.67, 'A', 2), (2, 8, 88.75, 9.05, 'D', 2), (2, 9, 95.00, 9.69, 'C', 3),
        (2, 10, 92.50, 9.43, 'D', 3), (2, 11, 98.00, 9.99, 'B', 3), (2, 12, 87.50, 8.92, 'E', 3);

        INSERT INTO dbo.UF (id_consorcio, id, m2, porcentaje, depto, piso) VALUES
        (3, 1, 120.00, 8.00, 'A', 0), (3, 2, 115.50, 7.70, 'B', 0), (3, 3, 125.00, 8.33, 'C', 0),
        (3, 4, 130.00, 8.67, 'A', 1), (3, 5, 128.75, 8.58, 'B', 1), (3, 6, 122.50, 8.17, 'C', 1),
        (3, 7, 135.00, 9.00, 'A', 2), (3, 8, 140.25, 9.35, 'B', 2), (3, 9, 132.00, 8.80, 'C', 2),
        (3, 10, 145.50, 9.70, 'A', 3), (3, 11, 138.00, 9.20, 'B', 3), (3, 12, 148.50, 9.90, 'C', 3);

        INSERT INTO dbo.UF (id_consorcio, id, m2, porcentaje, depto, piso) VALUES
        (4, 1, 75.00, 6.82, 'A', 0), (4, 2, 78.50, 7.14, 'B', 0), (4, 3, 82.00, 7.45, 'C', 0),
        (4, 4, 85.25, 7.75, 'A', 1), (4, 5, 88.00, 8.00, 'B', 1), (4, 6, 91.50, 8.32, 'C', 1),
        (4, 7, 95.00, 8.64, 'A', 2), (4, 8, 98.75, 8.98, 'B', 2), (4, 9, 102.00, 9.27, 'C', 2),
        (4, 10, 105.50, 9.59, 'A', 3), (4, 11, 108.00, 9.82, 'B', 3), (4, 12, 110.50, 10.05, 'C', 3);
        
        INSERT INTO dbo.Adicionales (id_consorcio, id_uf, m2, porcentaje, id_tipo_adicional) VALUES
        ...
        INSERT INTO dbo.Persona_UF (id_consorcio, id_uf, cvu_cbu, fecha) VALUES
        (1, 1, '0000003100012345678901', '2024-01-15'), (1, 2, '0000003100012345678902', '2024-01-15'),
        (1, 3, '0000003100012345678903', '2024-02-01'), (1, 4, '0000003100012345678904', '2024-01-15'),
        (1, 5, '0000003100012345678905', '2024-01-15'), (1, 6, '0000003100012345678906', '2024-03-01'),
        (1, 7, '0000003100012345678907', '2024-01-15'), (1, 8, '0000003100012345678908', '2024-01-15'),
        (1, 9, '0000003100012345678909', '2024-01-15'), (1, 10, '0000003100012345678910', '2024-02-15'),
        (1, 11, '0000003100012345678911', '2024-01-15'), (1, 12, '0000003100012345678912', '2024-01-15');

        INSERT INTO dbo.Persona_UF (id_consorcio, id_uf, cvu_cbu, fecha) VALUES
        (2, 1, '0000003100012345678913', '2024-01-10'), (2, 2, '0000003100012345678914', '2024-02-01'),
        (2, 3, '0000003100012345678915', '2024-01-10'), (2, 4, '0000003100012345678916', '2024-01-10'),
        (2, 5, '0000003100012345678917', '2024-01-10'), (2, 6, '0000003100012345678918', '2024-03-01'),
        (2, 7, '0000003100012345678919', '2024-01-10'), (2, 8, '0000003100012345678920', '2024-01-10'),
        (2, 9, '0000003100012345678921', '2024-01-10'), (2, 10, '0000003100012345678922', '2024-02-15'),
        (2, 11, '0000003100012345678923', '2024-01-10'), (2, 12, '0000003100012345678924', '2024-01-10');

        INSERT INTO dbo.Persona_UF (id_consorcio, id_uf, cvu_cbu, fecha) VALUES
        (3, 1, '0000003100012345678925', '2024-01-05'), (3, 2, '0000003100012345678926', '2024-01-05'),
        (3, 3, '0000003100012345678927', '2024-01-05'), (3, 4, '0000003100012345678928', '2024-02-01'),
        (3, 5, '0000003100012345678929', '2024-01-05'), (3, 6, '0000003100012345678930', '2024-01-05'),
        (3, 7, '0000003100012345678931', '2024-01-05'), (3, 8, '0000003100012345678932', '2024-03-01'),
        (3, 9, '0000003100012345678933', '2024-01-05'), (3, 10, '0000003100012345678934', '2024-01-05'),
        (3, 11, '0000003100012345678935', '2024-01-05'), (3, 12, '0000003100012345678936', '2024-02-15');

        INSERT INTO dbo.Persona_UF (id_consorcio, id_uf, cvu_cbu, fecha) VALUES
        (4, 1, '0000003100012345678937', '2024-01-08'), (4, 2, '0000003100012345678938', '2024-01-08'),
        (4, 3, '0000003100012345678939', '2024-01-08'), (4, 4, '0000003100012345678940', '2024-01-08'),
        (4, 5, '0000003100012345678941', '2024-02-01'), (4, 6, '0000003100012345678942', '2024-01-08'),
        (4, 7, '0000003100012345678943', '2024-01-08'), (4, 8, '0000003100012345678944', '2024-03-01'),
        (4, 9, '0000003100012345678945', '2024-01-08'), (4, 10, '0000003100012345678946', '2024-01-08'),
        (4, 11, '0000003100012345678947', '2024-01-08'), (4, 12, '0000003100012345678948', '2024-02-15');
        
        SET IDENTITY_INSERT dbo.Expensa ON;
        -- Octubre 2024
        INSERT INTO dbo.Expensa (id, id_consorcio, anio, mes, vence1, vence2) VALUES
        ...
        SET IDENTITY_INSERT dbo.Expensa OFF;
        
        SET IDENTITY_INSERT dbo.Detalle_Expensa ON;
        
        -- OCTUBRE 2024 TODOS LOS CONSORCIOS
        INSERT INTO dbo.Detalle_Expensa (id_det_exp, id_expensa, fecha, importe, id_proveedor, id_tipo_servicio, descripcion) VALUES
        -- Consorcio 1
        ...
        SET IDENTITY_INSERT dbo.Detalle_Expensa OFF;
        
        -- GASTOS ORDINARIOS
        INSERT INTO dbo.Gasto_Ordinario (id_gasto, nro_factura) VALUES
        ...
        INSERT INTO dbo.Gasto_Extraordinario (id_gasto, cant_cuota, cuota_pagada) VALUES
        ...
        INSERT INTO dbo.Pago (id_pago, fecha_pago, cbu_cvu, monto, id_exp) VALUES
